...
for filename in ../LLVM2/llvm-project/libc/src/math/gpu/*f.cpp; do
    ...
    make -i APP=driver64 BUILTINFUN=$fun VENDORFUN=__ocml_$fun\_f64 temps TMPOUT=temps/${fun}
    make -i APP=driver32 BUILTINFUN=$fun\f VENDORFUN=__ocml_$fun\_f32 temps TMPOUT=temps/${fun}f
