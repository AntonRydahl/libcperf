...
sinhf:
	...
	v_add_u32_e32 v1, 0xbd4c0000, v3
	s_mov_b32 s4, 0xfaec0000
...
.LBB2_3:
	...
	s_getpc_b64 s[6:7]
	s_add_u32 s6, s6, __const._ZN11__llvm_libc11exp_pm_evalILb1EEEdf.HALF_WAY@rel32@lo+4
	s_addc_u32 s7, s7, __const._ZN11__llvm_libc11exp_pm_evalILb1EEEdf.HALF_WAY@rel32@hi+12
	v_mov_b32_e32 v3, s7
	...
	s_mov_b32 s7, 0x40471547
	v_mov_b32_e32 v9, 0xfffe5bc8
	v_mov_b32_e32 v10, 0x3fcfffff
	v_mov_b32_e32 v11, 0x5555cd67
	v_mov_b32_e32 v12, 0x3fb55555
	s_waitcnt vmcnt(0)
	...
	v_cvt_f64_i32_e32 v[7:8], v13
	s_mov_b32 s6, 0xfefa0000
	s_mov_b32 s7, 0xbf962e42
	v_fma_f64 v[2:3], v[7:8], s[6:7], v[3:4]
	s_mov_b32 s6, 0xbc9e3b3a
	s_mov_b32 s7, 0xbd2cf79a
	v_lshlrev_b32_e32 v4, 15, v13
	v_and_b32_e32 v4, 0xfff00000, v4
	v_lshlrev_b32_e32 v13, 15, v14
	v_and_b32_e32 v13, 0xfff00000, v13
	v_fma_f64 v[2:3], v[7:8], s[6:7], v[2:3]
	s_mov_b32 s6, 0x2a9b48b4
	s_mov_b32 s7, 0x3f95555c
	v_mul_f64 v[7:8], v[2:3], v[2:3]
	v_fma_f64 v[9:10], v[7:8], s[6:7], v[9:10]
	s_mov_b32 s6, 0xa0e34bdb
	s_mov_b32 s7, 0x3f711112
	...
	s_waitcnt vmcnt(0)
	v_add_co_u32_e32 v4, vcc, 0, v5
	v_addc_co_u32_e32 v5, vcc, v13, v6, vcc
	v_add_f64 v[13:14], v[0:1], v[4:5]
	v_add_f64 v[0:1], v[0:1], -v[4:5]
	v_fma_f64 v[4:5], v[7:8], v[11:12], 0.5
...
.LBB2_12:
	...
	s_mov_b32 s8, 0x3a1285ff
	v_cmp_ne_u32_e32 vcc, s8, v3
	s_and_saveexec_b64 s[8:9], vcc
	s_xor_b64 s[8:9], exec, s[8:9]
	s_cbranch_execz .LBB2_19
	v_cvt_f64_f32_e32 v[1:2], v0
	s_mov_b32 s10, 0x32800000
	v_cmp_lt_u32_e32 vcc, s10, v3
	s_and_saveexec_b64 s[10:11], vcc
	s_xor_b64 s[10:11], exec, s[10:11]
	s_cbranch_execz .LBB2_16
	v_mul_f64 v[3:4], v[1:2], v[1:2]
	s_mov_b32 s12, 0xa284013c
	v_mov_b32_e32 v5, 0xd239f1f
	v_mov_b32_e32 v6, 0x3f811111
	s_mov_b32 s13, 0x3f2a02b5
	v_fma_f64 v[5:6], v[3:4], s[12:13], v[5:6]
	s_mov_b32 s12, 0x55556583
...
.LBB2_19:
	...
	s_getpc_b64 s[10:11]
	s_add_u32 s10, s10, _ZZN11__llvm_libc6fputil24fenv_is_round_to_nearestEvE1x@rel32@lo+4
	s_addc_u32 s11, s11, _ZZN11__llvm_libc6fputil24fenv_is_round_to_nearestEvE1x@rel32@hi+12
...
.LBB3_2:
	...
	v_mov_b32_e32 v19, 1
	s_getpc_b64 s[26:27]
	s_add_u32 s26, s26, sinhf@rel32@lo+4
	s_addc_u32 s27, s27, sinhf@rel32@hi+12
	s_branch .LBB3_6
.LBB3_5:
	s_or_b64 exec, exec, s[4:5]
...
.LBB3_8:
	...
	ds_read2_b32 v[2:3], v18 offset0:1 offset1:2
	s_waitcnt lgkmcnt(0)
	...
	ds_read_b32 v4, v18 offset:24
	v_cmp_gt_u32_e32 vcc, 2, v2
	s_mov_b64 s[34:35], 0
	s_waitcnt lgkmcnt(0)
	v_cndmask_b32_e32 v20, 1, v4, vcc
	v_add_u32_e32 v2, s33, v20
	v_add_u32_e32 v2, v2, v3
	v_ashrrev_i32_e32 v21, 31, v20
	v_ashrrev_i32_e32 v3, 31, v2
	v_sub_co_u32_e32 v16, vcc, v2, v20
...
.LBB3_11:
	...
	v_cmp_lt_u64_e32 vcc, s[24:25], v[16:17]
...
.LBB3_15:
	...
	.text
.Lfunc_end3:
	.size	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z5sinhfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23, .Lfunc_end3-__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z5sinhfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23
...
.LBB4_15:
	...
	.text
.Lfunc_end4:
	.size	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z15__ocml_sinh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23, .Lfunc_end4-__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z15__ocml_sinh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23
...
_ZZN11__llvm_libc6fputil15quick_get_roundEvE1x:
	...
	.type	__const._ZN11__llvm_libc11exp_pm_evalILb1EEEdf.HALF_WAY,@object
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	3, 0x0
__const._ZN11__llvm_libc11exp_pm_evalILb1EEEdf.HALF_WAY:
	.quad	0x3fe0000000000000
	.quad	0xbfe0000000000000
	.size	__const._ZN11__llvm_libc11exp_pm_evalILb1EEEdf.HALF_WAY, 16
