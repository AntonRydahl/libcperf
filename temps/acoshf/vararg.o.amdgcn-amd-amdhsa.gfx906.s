...
acoshf:
	...
	v_mov_b32_e32 v3, 0x42a28a1b
	flat_store_dword v[1:2], v3
	s_waitcnt vmcnt(0)
	flat_load_dword v4, v[1:2] glc
	s_waitcnt vmcnt(0)
	s_mov_b32 s20, 0x42a28a1b
	flat_store_dword v[1:2], v3
	s_waitcnt vmcnt(0)
...
.LBB2_9:
	...
	v_mov_b32_e32 v3, 0x42845a89
	flat_store_dword v[1:2], v3
	s_waitcnt vmcnt(0)
	flat_load_dword v4, v[1:2] glc
	s_waitcnt vmcnt(0)
	s_mov_b32 s22, 0x42845a89
	flat_store_dword v[1:2], v3
	s_waitcnt vmcnt(0)
	flat_load_dword v1, v[1:2] glc
	s_waitcnt vmcnt(0)
...
.LBB2_14:
	...
	v_lshrrev_b32_e64 v1, 6, s32
	v_mov_b32_e32 v2, s19
	v_mov_b32_e32 v3, 0x4254d1f9
	flat_store_dword v[1:2], v3
	s_waitcnt vmcnt(0)
	flat_load_dword v4, v[1:2] glc
	s_waitcnt vmcnt(0)
	s_mov_b32 s20, 0x4254d1f9
	flat_store_dword v[1:2], v3
	s_waitcnt vmcnt(0)
	flat_load_dword v1, v[1:2] glc
	s_waitcnt vmcnt(0)
...
.LBB2_19:
	...
	s_mov_b32 s14, 0x5c569e87
	v_cmp_lt_i32_e32 vcc, s14, v0
	s_and_saveexec_b64 s[14:15], vcc
	s_xor_b64 s[14:15], exec, s[14:15]
	s_cbranch_execz .LBB2_30
	s_mov_b32 s16, 0x5e68984d
	v_cmp_lt_i32_e32 vcc, s16, v0
	s_and_saveexec_b64 s[18:19], vcc
	s_xor_b64 s[18:19], exec, s[18:19]
	s_cbranch_execz .LBB2_25
	s_mov_b32 s16, 0x5e68984e
	v_cmp_eq_u32_e32 vcc, s16, v0
	s_mov_b64 s[20:21], -1
	s_and_saveexec_b64 s[16:17], vcc
	...
	v_lshrrev_b32_e64 v1, 6, s32
	v_mov_b32_e32 v2, s21
	v_mov_b32_e32 v3, 0x422e4a21
	flat_store_dword v[1:2], v3
	s_waitcnt vmcnt(0)
	flat_load_dword v4, v[1:2] glc
	s_waitcnt vmcnt(0)
	s_mov_b32 s22, 0x422e4a21
	flat_store_dword v[1:2], v3
	s_waitcnt vmcnt(0)
	flat_load_dword v1, v[1:2] glc
	s_waitcnt vmcnt(0)
...
.LBB2_25:
	...
	v_mov_b32_e32 v3, 0x4222e0a3
	flat_store_dword v[1:2], v3
	s_waitcnt vmcnt(0)
	flat_load_dword v4, v[1:2] glc
	s_waitcnt vmcnt(0)
	s_mov_b32 s24, 0x4222e0a3
	flat_store_dword v[1:2], v3
	s_waitcnt vmcnt(0)
	flat_load_dword v1, v[1:2] glc
	s_waitcnt vmcnt(0)
...
.LBB2_30:
	...
	v_lshrrev_b32_e64 v1, 6, s32
	v_mov_b32_e32 v2, s21
	v_mov_b32_e32 v3, 0x41b7ee9a
	flat_store_dword v[1:2], v3
	s_waitcnt vmcnt(0)
	flat_load_dword v4, v[1:2] glc
	s_waitcnt vmcnt(0)
	s_mov_b32 s22, 0x41b7ee9a
	flat_store_dword v[1:2], v3
	s_waitcnt vmcnt(0)
	flat_load_dword v1, v[1:2] glc
	s_waitcnt vmcnt(0)
...
.LBB2_37:
	...
	v_add_u32_e32 v10, 0xfffffc01, v5
	...
	v_add_u32_e32 v10, 0xfffffc0d, v2
	s_or_b64 exec, exec, s[4:5]
...
.LBB2_46:
	...
	v_add_co_u32_e64 v11, s[4:5], v11, v2
	v_cndmask_b32_e64 v8, v8, 0, vcc
	v_addc_co_u32_e64 v12, s[4:5], v12, v3, s[4:5]
	...
	v_add_co_u32_e64 v11, s[4:5], v14, v11
	v_cndmask_b32_e64 v8, v8, 0, vcc
	...
	v_cmp_lt_u64_e32 vcc, v[8:9], v[13:14]
	v_mov_b32_e32 v6, s5
	v_cndmask_b32_e64 v7, v6, 0, vcc
	v_mov_b32_e32 v6, s4
	v_cndmask_b32_e64 v6, v6, 0, vcc
	v_add_co_u32_e64 v6, s[4:5], v6, v11
	v_addc_co_u32_e64 v7, s[4:5], v7, v12, s[4:5]
...
.LBB2_49:
	...
	v_sub_co_u32_e64 v6, s[4:5], v4, v6
	v_subb_co_u32_e64 v4, s[4:5], v5, v7, s[4:5]
	v_mov_b32_e32 v7, 0xfff00000
	v_add_co_u32_e64 v2, s[4:5], 0, v2
	v_addc_co_u32_e64 v7, s[4:5], v3, v7, s[4:5]
	v_or_b32_e32 v3, v6, v8
	v_cmp_ne_u64_e64 s[4:5], 0, v[3:4]
	v_lshlrev_b32_e32 v5, 19, v10
	v_and_b32_e32 v5, 0xfff00000, v5
	s_and_b64 s[4:5], vcc, s[4:5]
	v_add_u32_e32 v5, 0x3ff00000, v5
...
.LBB2_52:
	...
	v_mov_b32_e32 v3, s5
	s_mov_b32 s10, 0x45e09c18
	v_mov_b32_e32 v8, 0xfefe562d
	v_mov_b32_e32 v9, 0xbfcfffff
	s_mov_b32 s11, 0x3fc1dc5c
	v_mov_b32_e32 v12, -4
	v_lshrrev_b32_e32 v2, 10, v1
	v_and_b32_e32 v4, 0x3f8, v2
...
.Lfunc_end2:
	...
	.protected	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23
	.weak	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23
	.p2align	8
	.type	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23,@function
__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23:
...
.LBB3_2:
	...
	v_mov_b32_e32 v19, 1
	s_getpc_b64 s[42:43]
	s_add_u32 s42, s42, acoshf@rel32@lo+4
	s_addc_u32 s43, s43, acoshf@rel32@hi+12
	s_branch .LBB3_6
.LBB3_5:
	s_or_b64 exec, exec, s[4:5]
	s_add_i32 s4, s40, s37
...
.LBB3_6:
	...
	ds_write_b32 v18, v0 offset:24
	ds_write2_b32 v18, v19, v19 offset0:1 offset1:2
.LBB3_8:
	s_or_b64 exec, exec, s[4:5]
	...
	ds_read2_b32 v[0:1], v18 offset0:1 offset1:2
	s_waitcnt lgkmcnt(0)
	v_cmp_eq_u32_e32 vcc, v1, v0
	v_cmp_ne_u32_e64 s[4:5], 0, v0
	s_and_b64 vcc, s[4:5], vcc
	v_cndmask_b32_e32 v1, 0, v15, vcc
	v_add_u32_e32 v16, s33, v1
	v_ashrrev_i32_e32 v17, 31, v16
	v_cmp_ge_u64_e32 vcc, s[40:41], v[16:17]
	s_and_saveexec_b64 s[44:45], vcc
	s_cbranch_execz .LBB3_12
	ds_read_b32 v1, v18 offset:24
	v_cmp_gt_u32_e32 vcc, 2, v0
	s_mov_b64 s[46:47], 0
	s_waitcnt lgkmcnt(0)
	v_cndmask_b32_e32 v20, 1, v1, vcc
.LBB3_11:
	v_lshlrev_b64 v[21:22], 2, v[16:17]
	v_mov_b32_e32 v1, s35
	v_add_co_u32_e32 v0, vcc, s34, v21
	...
	v_add_co_u32_e64 v1, s[4:5], s38, v21
	v_addc_co_u32_e64 v2, s[4:5], v2, v22, s[4:5]
...
.LBB3_13:
	...
	ds_write2_b32 v18, v18, v18 offset0:1 offset1:2
	ds_write_b32 v18, v19 offset:24
	s_branch .LBB3_5
.LBB3_15:
	s_endpgm
	.section	.rodata,#alloc
	.p2align	6, 0x0
	.amdhsa_kernel __omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23
		.amdhsa_group_segment_fixed_size 40
	...
	.text
.Lfunc_end3:
	.size	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23, .Lfunc_end3-__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23

	.protected	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23
	.weak	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23
	.p2align	8
	.type	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23,@function
__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23:
...
.LBB4_6:
	...
	ds_write2_b32 v5, v7, v7 offset0:1 offset1:2
.LBB4_8:
	s_or_b64 exec, exec, s[4:5]
...
.LBB4_15:
	...
	.section	.rodata,#alloc
	.p2align	6, 0x0
	.amdhsa_kernel __omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23
		.amdhsa_group_segment_fixed_size 40
		.amdhsa_private_segment_fixed_size 0
		.amdhsa_kernarg_size 24
		.amdhsa_user_sgpr_count 8
	...
	.text
.Lfunc_end4:
	.size	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23, .Lfunc_end4-__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23
...
__omp_offloading_4f_5896da36__ZN7gpumath13uniform_rangeIfEEvRNS_5ArrayIT_EES2_S2__l14_exec_mode:
	...
	.protected	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23_exec_mode
	.type	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23_exec_mode,@object
	.weak	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23_exec_mode
__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23_exec_mode:
	.byte	2
	.size	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23_exec_mode, 1

	.protected	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23_exec_mode
	.type	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23_exec_mode,@object
	.weak	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23_exec_mode
__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23_exec_mode:
	.byte	2
	.size	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23_exec_mode, 1
...
__omp_offloading_4f_5896da36__ZN7gpumath13uniform_rangeIfEEvRNS_5ArrayIT_EES2_S2__l14_nested_parallelism:
	...
	.type	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23_nested_parallelism,@object
	.weak	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23_nested_parallelism
__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23_nested_parallelism:
	.byte	0
	.size	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23_nested_parallelism, 1

	.type	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23_nested_parallelism,@object
	.weak	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23_nested_parallelism
__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23_nested_parallelism:
	.byte	0
	.size	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23_nested_parallelism, 1
...
__omp_offloading_4f_5896da36__ZN7gpumath13uniform_rangeIfEEvRNS_5ArrayIT_EES2_S2__l14_nested_parallelism.13:
	...
	.type	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23_nested_parallelism.14,@object
	.weak	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23_nested_parallelism.14
__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23_nested_parallelism.14:
	.byte	0
	.size	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23_nested_parallelism.14, 1

	.type	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23_nested_parallelism.15,@object
	.weak	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23_nested_parallelism.15
__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23_nested_parallelism.15:
	.byte	0
	.size	__omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23_nested_parallelism.15, 1
...
amdhsa.kernels:
  ...
  - .args:
    ...
    .language_version:
      ...
      - 0
    .max_flat_workgroup_size: 1024
    .name:           __omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23
    .private_segment_fixed_size: 8
    .sgpr_count:     55
    .sgpr_spill_count: 0
    .symbol:         __omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXcvPFffEadL_Z6acoshfEEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS4_IT_EE_l23.kd
    .vgpr_count:     23
    .vgpr_spill_count: 0
    .wavefront_size: 64
  - .args:
    ...
    .language_version:
      ...
      - 0
    .max_flat_workgroup_size: 1024
    .name:           __omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23
    .private_segment_fixed_size: 0
    .sgpr_count:     29
    .sgpr_spill_count: 0
    .symbol:         __omp_offloading_4f_5896da37__ZN7gpumath13apply_fun_gpuIfXadL_Z16__ocml_acosh_f32EEJfEEEdRSt5tupleIJDpNS_5ArrayIT1_EEEERNS2_IT_EE_l23.kd
    .vgpr_count:     26
    .vgpr_spill_count: 0
    .wavefront_size: 64
